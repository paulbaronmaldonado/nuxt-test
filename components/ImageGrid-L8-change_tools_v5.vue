  ...
  <div class="transform-grid">
    ...
    <div class="row-btns icon-row" style="margin-top:8px;">
      ...
      <div class="nudge-inline">
        ...
        <button class="btn tiny icon-btn" @click="nudgeTransform(0,10)" :disabled="!canTransform" title="Down" style="margin-top:6px">▼</button>
      </div>
    </div>
  </div>
</section>
